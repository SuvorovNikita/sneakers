...
function App() {
  ...
  React.useEffect(() => {
    axios.get('https://61a4d9d34c822c0017041f37.mockapi.io/items').then((res) => {
      setItems(res.data);
    });
    axios.get('https://61a4d9d34c822c0017041f37.mockapi.io/cart').then((res) => {
      setCartItems(res.data);
    });
    axios.get('https://61a4d9d34c822c0017041f37.mockapi.io/favorites').then((res) => {
